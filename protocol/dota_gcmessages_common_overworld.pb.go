...
type CMsgClientToGCOverworldDevSetFortuneResponse struct {
	state         protoimpl.MessageState                                  `protogen:"open.v1"`
	Response      *CMsgClientToGCOverworldDevSetFortuneResponse_EResponse `protobuf:"varint,1,opt,name=response,enum=protocol.CMsgClientToGCOverworldDevSetFortuneResponse_EResponse,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCOverworldDevClearFortuneResponse struct {
	state         protoimpl.MessageState                                    `protogen:"open.v1"`
	Response      *CMsgClientToGCOverworldDevClearFortuneResponse_EResponse `protobuf:"varint,1,opt,name=response,enum=protocol.CMsgClientToGCOverworldDevClearFortuneResponse_EResponse,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_dota_gcmessages_common_overworld_proto_rawDesc = "" +
	...
	"\n" +
	"fortune_id\x18\x02 \x01(\rR\tfortuneId\"\xaf\x02\n" +
	",CMsgClientToGCOverworldDevSetFortuneResponse\x12n\n" +
	"\bresponse\x18\x01 \x01(\x0e2@.protocol.CMsgClientToGCOverworldDevSetFortuneResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x8e\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\x12\x1d\n" +
	"\n" +
	"fortune_id\x18\x02 \x01(\rR\tfortuneId\"\xb3\x02\n" +
	".CMsgClientToGCOverworldDevClearFortuneResponse\x12p\n" +
	"\bresponse\x18\x01 \x01(\x0e2B.protocol.CMsgClientToGCOverworldDevClearFortuneResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x8e\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
