...
var file_dota_shared_enums_proto_goTypes = []interface{}{
	...
	(DOTALobbyVisibility)(0),                           // 20: protocol.DOTALobbyVisibility
	(EDOTAPlayerMMRType)(0),                            // 21: protocol.EDOTAPlayerMMRType
	(EDOTAMMRBoostType)(0),                             // 22: protocol.EDOTAMMRBoostType
	(MatchType)(0),                                     // 23: protocol.MatchType
	(DOTABotDifficulty)(0),                             // 24: protocol.DOTABotDifficulty
	(DOTA_BOT_MODE)(0),                                 // 25: protocol.DOTA_BOT_MODE
	(MatchLanguages)(0),                                // 26: protocol.MatchLanguages
	(ETourneyQueueDeadlineState)(0),                    // 27: protocol.ETourneyQueueDeadlineState
	(EMatchOutcome)(0),                                 // 28: protocol.EMatchOutcome
	(ELaneType)(0),                                     // 29: protocol.ELaneType
	(EBadgeType)(0),                                    // 30: protocol.EBadgeType
	(ELeagueStatus)(0),                                 // 31: protocol.ELeagueStatus
	(ELeagueRegion)(0),                                 // 32: protocol.ELeagueRegion
	(ELeagueTier)(0),                                   // 33: protocol.ELeagueTier
	(ELeagueTierCategory)(0),                           // 34: protocol.ELeagueTierCategory
	(ELeagueFlags)(0),                                  // 35: protocol.ELeagueFlags
	...
	(*CDOTAClientHardwareSpecs)(nil),                   // 43: protocol.CDOTAClientHardwareSpecs
	(*CDOTASaveGame)(nil),                              // 44: protocol.CDOTASaveGame
	(*CMsgDOTACombatLogEntry)(nil),                     // 45: protocol.CMsgDOTACombatLogEntry
	(*CMsgPendingEventAward)(nil),                      // 46: protocol.CMsgPendingEventAward
	(*CDOTASaveGame_Player)(nil),                       // 47: protocol.CDOTASaveGame.Player
	(*CDOTASaveGame_SaveInstance)(nil),                 // 48: protocol.CDOTASaveGame.SaveInstance
	(*CDOTASaveGame_SaveInstance_PlayerPositions)(nil), // 49: protocol.CDOTASaveGame.SaveInstance.PlayerPositions
}
var file_dota_shared_enums_proto_depIdxs = []int32{
	47, // 0: protocol.CDOTASaveGame.players:type_name -> protocol.CDOTASaveGame.Player
	48, // 1: protocol.CDOTASaveGame.save_instances:type_name -> protocol.CDOTASaveGame.SaveInstance
	...
	49, // 6: protocol.CDOTASaveGame.SaveInstance.player_positions:type_name -> protocol.CDOTASaveGame.SaveInstance.PlayerPositions
