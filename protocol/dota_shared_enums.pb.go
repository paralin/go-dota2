...
var file_dota_shared_enums_proto_rawDesc = []byte{
	...
	0x01, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01, 0x79, 0x22, 0xa4, 0x18, 0x0a, 0x16,
	...
	0x73, 0x74, 0x5f, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x18, 0x28, 0x20, 0x03, 0x28, 0x0d,
	...
	0x65, 0x72, 0x22, 0x92, 0x02, 0x0a, 0x15, 0x43, 0x4d, 0x73, 0x67, 0x50, 0x65, 0x6e, 0x64, 0x69,
	0x6e, 0x67, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x41, 0x77, 0x61, 0x72, 0x64, 0x12, 0x3a, 0x0a, 0x08,
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10,
	...
	0x54, 0x6f, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x12, 0x5b, 0x0a, 0x0a, 0x73, 0x63, 0x6f, 0x72, 0x65,
	0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x45, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x41, 0x63, 0x74,
	...
	0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x63, 0x6f, 0x72,
	0x65, 0x4d, 0x6f, 0x64, 0x65, 0x5f, 0x4d, 0x69, 0x6e, 0x10, 0x01, 0x42, 0x11, 0x48, 0x01, 0x5a,
	0x0a, 0x2e, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x80, 0x01, 0x00,
}
...
var file_dota_shared_enums_proto_goTypes = []interface{}{
	...
	(EProfileCardSlotType)(0),                          // 10: protocol.EProfileCardSlotType
	(EMatchGroupServerStatus)(0),                       // 11: protocol.EMatchGroupServerStatus
	(DOTA_CM_PICK)(0),                                  // 12: protocol.DOTA_CM_PICK
	(DOTALowPriorityBanType)(0),                        // 13: protocol.DOTALowPriorityBanType
	(DOTALobbyReadyState)(0),                           // 14: protocol.DOTALobbyReadyState
	(DOTAGameVersion)(0),                               // 15: protocol.DOTAGameVersion
	(DOTAJoinLobbyResult)(0),                           // 16: protocol.DOTAJoinLobbyResult
	(DOTASelectionPriorityRules)(0),                    // 17: protocol.DOTASelectionPriorityRules
	(DOTASelectionPriorityChoice)(0),                   // 18: protocol.DOTASelectionPriorityChoice
	(DOTAMatchVote)(0),                                 // 19: protocol.DOTAMatchVote
	(DOTA_LobbyMemberXPBonus)(0),                       // 20: protocol.DOTA_LobbyMemberXPBonus
	...
	(ELeagueFlags)(0),                                  // 36: protocol.ELeagueFlags
	...
	(*CDOTAClientHardwareSpecs)(nil),                   // 44: protocol.CDOTAClientHardwareSpecs
	(*CDOTASaveGame)(nil),                              // 45: protocol.CDOTASaveGame
	(*CMsgDOTACombatLogEntry)(nil),                     // 46: protocol.CMsgDOTACombatLogEntry
	(*CMsgPendingEventAward)(nil),                      // 47: protocol.CMsgPendingEventAward
	(*CDOTASaveGame_Player)(nil),                       // 48: protocol.CDOTASaveGame.Player
	(*CDOTASaveGame_SaveInstance)(nil),                 // 49: protocol.CDOTASaveGame.SaveInstance
	(*CDOTASaveGame_SaveInstance_PlayerPositions)(nil), // 50: protocol.CDOTASaveGame.SaveInstance.PlayerPositions
}
var file_dota_shared_enums_proto_depIdxs = []int32{
	48, // 0: protocol.CDOTASaveGame.players:type_name -> protocol.CDOTASaveGame.Player
	49, // 1: protocol.CDOTASaveGame.save_instances:type_name -> protocol.CDOTASaveGame.SaveInstance
	...
	50, // 6: protocol.CDOTASaveGame.SaveInstance.player_positions:type_name -> protocol.CDOTASaveGame.SaveInstance.PlayerPositions
