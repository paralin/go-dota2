...
func (m *CDOTAClientHardwareSpecs) CloneVT() *CDOTAClientHardwareSpecs {
	...
	r.LogicalProcessors = protobuf_go_lite.ClonePtr(m.LogicalProcessors)
	r.CpuCyclesPerSecond = protobuf_go_lite.ClonePtr(m.CpuCyclesPerSecond)
	r.TotalPhysicalMemory = protobuf_go_lite.ClonePtr(m.TotalPhysicalMemory)
	r.Is_64BitOs = protobuf_go_lite.ClonePtr(m.Is_64BitOs)
	r.UploadMeasurement = protobuf_go_lite.ClonePtr(m.UploadMeasurement)
	r.PreferNotHost = protobuf_go_lite.ClonePtr(m.PreferNotHost)
	r.Crc = protobuf_go_lite.CloneSlice(m.Crc)
...
func (m *CDOTASaveGame_Player) CloneVT() *CDOTASaveGame_Player {
	...
	r.Hero = protobuf_go_lite.ClonePtr(m.Hero)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *CDOTASaveGame_SaveInstance) CloneVT() *CDOTASaveGame_SaveInstance {
	...
	r.Team1Score = protobuf_go_lite.ClonePtr(m.Team1Score)
	r.Team2Score = protobuf_go_lite.ClonePtr(m.Team2Score)
	r.PlayerPositions = protobuf_go_lite.CloneVTSlice(m.PlayerPositions)
	r.SaveId = protobuf_go_lite.ClonePtr(m.SaveId)
	r.SaveTime = protobuf_go_lite.ClonePtr(m.SaveTime)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *CDOTASaveGame) CloneVT() *CDOTASaveGame {
	...
	r.SaveInstances = protobuf_go_lite.CloneVTSlice(m.SaveInstances)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *CMsgDOTACombatLogEntry) CloneVT() *CMsgDOTACombatLogEntry {
	...
	r.TargetName = protobuf_go_lite.ClonePtr(m.TargetName)
	r.TargetSourceName = protobuf_go_lite.ClonePtr(m.TargetSourceName)
	r.AttackerName = protobuf_go_lite.ClonePtr(m.AttackerName)
	r.DamageSourceName = protobuf_go_lite.ClonePtr(m.DamageSourceName)
	r.InflictorName = protobuf_go_lite.ClonePtr(m.InflictorName)
	r.IsAttackerIllusion = protobuf_go_lite.ClonePtr(m.IsAttackerIllusion)
	r.IsAttackerHero = protobuf_go_lite.ClonePtr(m.IsAttackerHero)
	r.IsTargetIllusion = protobuf_go_lite.ClonePtr(m.IsTargetIllusion)
	r.IsTargetHero = protobuf_go_lite.ClonePtr(m.IsTargetHero)
	r.IsVisibleRadiant = protobuf_go_lite.ClonePtr(m.IsVisibleRadiant)
	r.IsVisibleDire = protobuf_go_lite.ClonePtr(m.IsVisibleDire)
	...
	r.SlowDuration = protobuf_go_lite.ClonePtr(m.SlowDuration)
	r.IsAbilityToggleOn = protobuf_go_lite.ClonePtr(m.IsAbilityToggleOn)
	r.IsAbilityToggleOff = protobuf_go_lite.ClonePtr(m.IsAbilityToggleOff)
	r.AbilityLevel = protobuf_go_lite.ClonePtr(m.AbilityLevel)
	r.LocationX = protobuf_go_lite.ClonePtr(m.LocationX)
	r.LocationY = protobuf_go_lite.ClonePtr(m.LocationY)
	r.GoldReason = protobuf_go_lite.ClonePtr(m.GoldReason)
	r.TimestampRaw = protobuf_go_lite.ClonePtr(m.TimestampRaw)
	r.ModifierDuration = protobuf_go_lite.ClonePtr(m.ModifierDuration)
	r.XpReason = protobuf_go_lite.ClonePtr(m.XpReason)
	r.LastHits = protobuf_go_lite.ClonePtr(m.LastHits)
	r.AttackerTeam = protobuf_go_lite.ClonePtr(m.AttackerTeam)
	r.TargetTeam = protobuf_go_lite.ClonePtr(m.TargetTeam)
	r.ObsWardsPlaced = protobuf_go_lite.ClonePtr(m.ObsWardsPlaced)
	r.AssistPlayer0 = protobuf_go_lite.ClonePtr(m.AssistPlayer0)
	r.AssistPlayer1 = protobuf_go_lite.ClonePtr(m.AssistPlayer1)
	r.AssistPlayer2 = protobuf_go_lite.ClonePtr(m.AssistPlayer2)
	r.AssistPlayer3 = protobuf_go_lite.ClonePtr(m.AssistPlayer3)
	r.StackCount = protobuf_go_lite.ClonePtr(m.StackCount)
	r.HiddenModifier = protobuf_go_lite.ClonePtr(m.HiddenModifier)
	r.IsTargetBuilding = protobuf_go_lite.ClonePtr(m.IsTargetBuilding)
	r.NeutralCampType = protobuf_go_lite.ClonePtr(m.NeutralCampType)
	r.RuneType = protobuf_go_lite.ClonePtr(m.RuneType)
	r.AssistPlayers = protobuf_go_lite.CloneSlice(m.AssistPlayers)
	r.IsHealSave = protobuf_go_lite.ClonePtr(m.IsHealSave)
	r.IsUltimateAbility = protobuf_go_lite.ClonePtr(m.IsUltimateAbility)
	r.AttackerHeroLevel = protobuf_go_lite.ClonePtr(m.AttackerHeroLevel)
	r.TargetHeroLevel = protobuf_go_lite.ClonePtr(m.TargetHeroLevel)
	r.Xpm = protobuf_go_lite.ClonePtr(m.Xpm)
	r.Gpm = protobuf_go_lite.ClonePtr(m.Gpm)
	r.EventLocation = protobuf_go_lite.ClonePtr(m.EventLocation)
	r.TargetIsSelf = protobuf_go_lite.ClonePtr(m.TargetIsSelf)
	r.DamageType = protobuf_go_lite.ClonePtr(m.DamageType)
	r.InvisibilityModifier = protobuf_go_lite.ClonePtr(m.InvisibilityModifier)
	r.DamageCategory = protobuf_go_lite.ClonePtr(m.DamageCategory)
	r.Networth = protobuf_go_lite.ClonePtr(m.Networth)
	r.BuildingType = protobuf_go_lite.ClonePtr(m.BuildingType)
	r.ModifierElapsedDuration = protobuf_go_lite.ClonePtr(m.ModifierElapsedDuration)
	r.SilenceModifier = protobuf_go_lite.ClonePtr(m.SilenceModifier)
	r.HealFromLifesteal = protobuf_go_lite.ClonePtr(m.HealFromLifesteal)
	r.ModifierPurged = protobuf_go_lite.ClonePtr(m.ModifierPurged)
	r.SpellEvaded = protobuf_go_lite.ClonePtr(m.SpellEvaded)
	r.MotionControllerModifier = protobuf_go_lite.ClonePtr(m.MotionControllerModifier)
	r.LongRangeKill = protobuf_go_lite.ClonePtr(m.LongRangeKill)
	r.ModifierPurgeAbility = protobuf_go_lite.ClonePtr(m.ModifierPurgeAbility)
	r.ModifierPurgeNpc = protobuf_go_lite.ClonePtr(m.ModifierPurgeNpc)
	r.RootModifier = protobuf_go_lite.ClonePtr(m.RootModifier)
	r.TotalUnitDeathCount = protobuf_go_lite.ClonePtr(m.TotalUnitDeathCount)
	r.AuraModifier = protobuf_go_lite.ClonePtr(m.AuraModifier)
	r.ArmorDebuffModifier = protobuf_go_lite.ClonePtr(m.ArmorDebuffModifier)
	r.NoPhysicalDamageModifier = protobuf_go_lite.ClonePtr(m.NoPhysicalDamageModifier)
	r.ModifierAbility = protobuf_go_lite.ClonePtr(m.ModifierAbility)
	r.ModifierHidden = protobuf_go_lite.ClonePtr(m.ModifierHidden)
	r.InflictorIsStolenAbility = protobuf_go_lite.ClonePtr(m.InflictorIsStolenAbility)
	r.KillEaterEvent = protobuf_go_lite.ClonePtr(m.KillEaterEvent)
	r.UnitStatusLabel = protobuf_go_lite.ClonePtr(m.UnitStatusLabel)
	r.SpellGeneratedAttack = protobuf_go_lite.ClonePtr(m.SpellGeneratedAttack)
	r.AtNightTime = protobuf_go_lite.ClonePtr(m.AtNightTime)
	r.AttackerHasScepter = protobuf_go_lite.ClonePtr(m.AttackerHasScepter)
	r.NeutralCampTeam = protobuf_go_lite.ClonePtr(m.NeutralCampTeam)
	r.RegeneratedHealth = protobuf_go_lite.ClonePtr(m.RegeneratedHealth)
	r.WillReincarnate = protobuf_go_lite.ClonePtr(m.WillReincarnate)
	r.UsesCharges = protobuf_go_lite.ClonePtr(m.UsesCharges)
	r.TrackedStatId = protobuf_go_lite.ClonePtr(m.TrackedStatId)
	r.ModifierPurgedDuration = protobuf_go_lite.ClonePtr(m.ModifierPurgedDuration)
	r.HealFromRegen = protobuf_go_lite.ClonePtr(m.HealFromRegen)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *CMsgPendingEventAward) CloneVT() *CMsgPendingEventAward {
	...
	r.NumToGrant = protobuf_go_lite.ClonePtr(m.NumToGrant)
	r.ScoreMode = protobuf_go_lite.ClonePtr(m.ScoreMode)
...
func (m *CMsgMonsterHunterMaterialQuantity) CloneVT() *CMsgMonsterHunterMaterialQuantity {
	...
	r.MaterialCounts = protobuf_go_lite.CloneVTSlice(m.MaterialCounts)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *CMsgMonsterHunterInvestigation) CloneVT() *CMsgMonsterHunterInvestigation {
	...
	r.PersonaId = protobuf_go_lite.ClonePtr(m.PersonaId)
	r.MatchRewards = protobuf_go_lite.CloneVTValue(m.MatchRewards)
	r.HuntRewards = protobuf_go_lite.CloneVTValue(m.HuntRewards)
	r.SuccessState = protobuf_go_lite.ClonePtr(m.SuccessState)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *CMsgMonsterHunterInvestigationGameState) CloneVT() *CMsgMonsterHunterInvestigationGameState {
	...
	r.SelectedInvestigation = protobuf_go_lite.CloneVTValue(m.SelectedInvestigation)
	r.HuntedBy = protobuf_go_lite.CloneVTSlice(m.HuntedBy)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *CMsgMonsterHunterCodexUpdateData_KillInfo) CloneVT() *CMsgMonsterHunterCodexUpdateData_KillInfo {
	...
	r.HeroId = protobuf_go_lite.ClonePtr(m.HeroId)
	r.KillCount = protobuf_go_lite.ClonePtr(m.KillCount)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (m *CMsgMonsterHunterCodexUpdateData) CloneVT() *CMsgMonsterHunterCodexUpdateData {
	...
	r.PlayerHero = protobuf_go_lite.ClonePtr(m.PlayerHero)
	r.Allies = protobuf_go_lite.CloneSlice(m.Allies)
	r.Enemies = protobuf_go_lite.CloneSlice(m.Enemies)
	r.PlayerKills = protobuf_go_lite.CloneVTSlice(m.PlayerKills)
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
	return r
...
func (this *CDOTAClientHardwareSpecs) EqualVT(that *CDOTAClientHardwareSpecs) bool {
	...
	if !protobuf_go_lite.EqualPtr(this.LogicalProcessors, that.LogicalProcessors) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.CpuCyclesPerSecond, that.CpuCyclesPerSecond) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.TotalPhysicalMemory, that.TotalPhysicalMemory) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.Is_64BitOs, that.Is_64BitOs) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.UploadMeasurement, that.UploadMeasurement) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.PreferNotHost, that.PreferNotHost) {
		return false
	}
	if !protobuf_go_lite.EqualSlice(this.Crc, that.Crc) {
		return false
	}
...
func (this *CDOTASaveGame_Player) EqualVT(that *CDOTASaveGame_Player) bool {
	...
	if !protobuf_go_lite.EqualPtr(this.Hero, that.Hero) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *CDOTASaveGame_SaveInstance) EqualVT(that *CDOTASaveGame_SaveInstance) bool {
	...
	if !protobuf_go_lite.EqualPtr(this.Team1Score, that.Team1Score) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.Team2Score, that.Team2Score) {
		return false
	}
	if !protobuf_go_lite.EqualVTSliceImplicit(this.PlayerPositions, that.PlayerPositions, func() *CDOTASaveGame_SaveInstance_PlayerPositions {
		return &CDOTASaveGame_SaveInstance_PlayerPositions{}
	}) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.SaveId, that.SaveId) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.SaveTime, that.SaveTime) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *CDOTASaveGame) EqualVT(that *CDOTASaveGame) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.Players, that.Players, func() *CDOTASaveGame_Player { return &CDOTASaveGame_Player{} }) {
		return false
	}
	if !protobuf_go_lite.EqualVTSliceImplicit(this.SaveInstances, that.SaveInstances, func() *CDOTASaveGame_SaveInstance { return &CDOTASaveGame_SaveInstance{} }) {
		return false
	}
...
func (this *CMsgDOTACombatLogEntry) EqualVT(that *CMsgDOTACombatLogEntry) bool {
	...
	if !protobuf_go_lite.EqualPtr(this.TargetName, that.TargetName) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.TargetSourceName, that.TargetSourceName) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AttackerName, that.AttackerName) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.DamageSourceName, that.DamageSourceName) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.InflictorName, that.InflictorName) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsAttackerIllusion, that.IsAttackerIllusion) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsAttackerHero, that.IsAttackerHero) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsTargetIllusion, that.IsTargetIllusion) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsTargetHero, that.IsTargetHero) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsVisibleRadiant, that.IsVisibleRadiant) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsVisibleDire, that.IsVisibleDire) {
		return false
	}
	...
	if !protobuf_go_lite.EqualPtr(this.SlowDuration, that.SlowDuration) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsAbilityToggleOn, that.IsAbilityToggleOn) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsAbilityToggleOff, that.IsAbilityToggleOff) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AbilityLevel, that.AbilityLevel) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.LocationX, that.LocationX) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.LocationY, that.LocationY) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.GoldReason, that.GoldReason) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.TimestampRaw, that.TimestampRaw) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ModifierDuration, that.ModifierDuration) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.XpReason, that.XpReason) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.LastHits, that.LastHits) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AttackerTeam, that.AttackerTeam) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.TargetTeam, that.TargetTeam) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ObsWardsPlaced, that.ObsWardsPlaced) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AssistPlayer0, that.AssistPlayer0) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AssistPlayer1, that.AssistPlayer1) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AssistPlayer2, that.AssistPlayer2) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AssistPlayer3, that.AssistPlayer3) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.StackCount, that.StackCount) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.HiddenModifier, that.HiddenModifier) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsTargetBuilding, that.IsTargetBuilding) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.NeutralCampType, that.NeutralCampType) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.RuneType, that.RuneType) {
		return false
	}
	if !protobuf_go_lite.EqualSlice(this.AssistPlayers, that.AssistPlayers) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsHealSave, that.IsHealSave) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.IsUltimateAbility, that.IsUltimateAbility) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AttackerHeroLevel, that.AttackerHeroLevel) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.TargetHeroLevel, that.TargetHeroLevel) {
		return false
	}
	...
	if !protobuf_go_lite.EqualPtr(this.EventLocation, that.EventLocation) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.TargetIsSelf, that.TargetIsSelf) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.DamageType, that.DamageType) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.InvisibilityModifier, that.InvisibilityModifier) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.DamageCategory, that.DamageCategory) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.Networth, that.Networth) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.BuildingType, that.BuildingType) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ModifierElapsedDuration, that.ModifierElapsedDuration) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.SilenceModifier, that.SilenceModifier) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.HealFromLifesteal, that.HealFromLifesteal) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ModifierPurged, that.ModifierPurged) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.SpellEvaded, that.SpellEvaded) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.MotionControllerModifier, that.MotionControllerModifier) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.LongRangeKill, that.LongRangeKill) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ModifierPurgeAbility, that.ModifierPurgeAbility) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ModifierPurgeNpc, that.ModifierPurgeNpc) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.RootModifier, that.RootModifier) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.TotalUnitDeathCount, that.TotalUnitDeathCount) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AuraModifier, that.AuraModifier) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ArmorDebuffModifier, that.ArmorDebuffModifier) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.NoPhysicalDamageModifier, that.NoPhysicalDamageModifier) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ModifierAbility, that.ModifierAbility) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ModifierHidden, that.ModifierHidden) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.InflictorIsStolenAbility, that.InflictorIsStolenAbility) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.KillEaterEvent, that.KillEaterEvent) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.UnitStatusLabel, that.UnitStatusLabel) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.SpellGeneratedAttack, that.SpellGeneratedAttack) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AtNightTime, that.AtNightTime) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.AttackerHasScepter, that.AttackerHasScepter) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.NeutralCampTeam, that.NeutralCampTeam) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.RegeneratedHealth, that.RegeneratedHealth) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.WillReincarnate, that.WillReincarnate) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.UsesCharges, that.UsesCharges) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.TrackedStatId, that.TrackedStatId) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ModifierPurgedDuration, that.ModifierPurgedDuration) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.HealFromRegen, that.HealFromRegen) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *CMsgPendingEventAward) EqualVT(that *CMsgPendingEventAward) bool {
	...
	if !protobuf_go_lite.EqualPtr(this.NumToGrant, that.NumToGrant) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.ScoreMode, that.ScoreMode) {
		return false
	}
...
func (this *CMsgMonsterHunterMaterialQuantity) EqualVT(that *CMsgMonsterHunterMaterialQuantity) bool {
	...
	if !protobuf_go_lite.EqualVTSliceImplicit(this.MaterialCounts, that.MaterialCounts, func() *CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry {
		return &CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry{}
	}) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *CMsgMonsterHunterInvestigation) EqualVT(that *CMsgMonsterHunterInvestigation) bool {
	...
	if !protobuf_go_lite.EqualPtr(this.PersonaId, that.PersonaId) {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.MatchRewards, that.MatchRewards) {
		return false
	}
	if !protobuf_go_lite.IsEqualVT(this.HuntRewards, that.HuntRewards) {
		return false
	}
	if !protobuf_go_lite.EqualPtr(this.SuccessState, that.SuccessState) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *CMsgMonsterHunterInvestigationGameState) EqualVT(that *CMsgMonsterHunterInvestigationGameState) bool {
	...
	if !protobuf_go_lite.IsEqualVT(this.SelectedInvestigation, that.SelectedInvestigation) {
		return false
	}
	if !protobuf_go_lite.EqualVTSliceImplicit(this.HuntedBy, that.HuntedBy, func() *CMsgMonsterHunterInvestigationGameState_HuntedBy {
		return &CMsgMonsterHunterInvestigationGameState_HuntedBy{}
	}) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
...
func (this *CMsgMonsterHunterCodexUpdateData_KillInfo) EqualVT(that *CMsgMonsterHunterCodexUpdateData_KillInfo) bool {
	...
	if !protobuf_go_lite.EqualPtr(this.KillCount, that.KillCount) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *CMsgMonsterHunterCodexUpdateData) EqualVT(that *CMsgMonsterHunterCodexUpdateData) bool {
	...
	if !protobuf_go_lite.EqualPtr(this.PlayerHero, that.PlayerHero) {
		return false
	}
	if !protobuf_go_lite.EqualSlice(this.Allies, that.Allies) {
		return false
	}
	if !protobuf_go_lite.EqualSlice(this.Enemies, that.Enemies) {
		return false
	}
	if !protobuf_go_lite.EqualVTSliceImplicit(this.PlayerKills, that.PlayerKills, func() *CMsgMonsterHunterCodexUpdateData_KillInfo { return &CMsgMonsterHunterCodexUpdateData_KillInfo{} }) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *CDOTAClientHardwareSpecs) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PreferNotHost != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.PreferNotHost)
		i--
		dAtA[i] = 0x30
	}
	...
	if m.Is_64BitOs != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.Is_64BitOs)
		i--
		dAtA[i] = 0x20
	}
	if m.TotalPhysicalMemory != nil {
		i = protobuf_go_lite.EncodeFixed64(dAtA, i, uint64(*m.TotalPhysicalMemory))
		i--
		dAtA[i] = 0x19
	}
	if m.CpuCyclesPerSecond != nil {
		i = protobuf_go_lite.EncodeFixed64(dAtA, i, uint64(*m.CpuCyclesPerSecond))
		i--
		dAtA[i] = 0x11
	}
...
func (m *CDOTASaveGame_Player) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Hero != nil {
		i = protobuf_go_lite.EncodeString(dAtA, i, *m.Hero)
		i--
		dAtA[i] = 0x1a
	}
	if m.Name != nil {
...
func (m *CMsgDOTACombatLogEntry) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.HealFromRegen != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.HealFromRegen)
		i--
		dAtA[i] = 0x5
		i--
		dAtA[i] = 0x90
	...
	if m.ModifierPurgedDuration != nil {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(*m.ModifierPurgedDuration))))
		i--
		dAtA[i] = 0x5
		i--
		dAtA[i] = 0x8d
	...
	if m.UsesCharges != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.UsesCharges)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0xf8
	...
	if m.WillReincarnate != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.WillReincarnate)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0xf0
	...
	if m.RegeneratedHealth != nil {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(*m.RegeneratedHealth))))
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0xed
	...
	if m.AttackerHasScepter != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.AttackerHasScepter)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0xd8
	...
	if m.AtNightTime != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.AtNightTime)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0xd0
	...
	if m.SpellGeneratedAttack != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.SpellGeneratedAttack)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0xc8
	...
	if m.InflictorIsStolenAbility != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.InflictorIsStolenAbility)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0xb0
	...
	if m.ModifierHidden != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.ModifierHidden)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0xa8
	...
	if m.NoPhysicalDamageModifier != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.NoPhysicalDamageModifier)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0x98
	...
	if m.ArmorDebuffModifier != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.ArmorDebuffModifier)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0x90
	...
	if m.AuraModifier != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.AuraModifier)
		i--
		dAtA[i] = 0x4
		i--
		dAtA[i] = 0x88
	...
	if m.RootModifier != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.RootModifier)
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xf8
	...
	if m.LongRangeKill != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.LongRangeKill)
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xe0
	...
	if m.MotionControllerModifier != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.MotionControllerModifier)
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xd8
	...
	if m.SpellEvaded != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.SpellEvaded)
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xd0
	...
	if m.ModifierPurged != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.ModifierPurged)
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xc8
	...
	if m.HealFromLifesteal != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.HealFromLifesteal)
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xc0
	...
	if m.SilenceModifier != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.SilenceModifier)
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xb8
	...
	if m.ModifierElapsedDuration != nil {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(*m.ModifierElapsedDuration))))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xb5
	...
	if m.InvisibilityModifier != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.InvisibilityModifier)
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x90
	...
	if m.TargetIsSelf != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.TargetIsSelf)
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x80
	...
	if m.IsUltimateAbility != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsUltimateAbility)
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xd0
	...
	if m.IsHealSave != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsHealSave)
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xc8
	...
	if m.IsTargetBuilding != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsTargetBuilding)
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xa8
	...
	if m.HiddenModifier != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.HiddenModifier)
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xa0
	...
	if m.ModifierDuration != nil {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(*m.ModifierDuration))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xcd
	...
	if m.TimestampRaw != nil {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(*m.TimestampRaw))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc5
	...
	if m.LocationY != nil {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(*m.LocationY))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb5
	...
	if m.LocationX != nil {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(*m.LocationX))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xad
	...
	if m.IsAbilityToggleOff != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsAbilityToggleOff)
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
	...
	if m.IsAbilityToggleOn != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsAbilityToggleOn)
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x90
	...
	if m.SlowDuration != nil {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(*m.SlowDuration))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8d
	...
	if m.Timestamp != nil {
		i = protobuf_go_lite.EncodeFixed32(dAtA, i, uint32(math.Float32bits(float32(*m.Timestamp))))
		i--
		dAtA[i] = 0x7d
	}
	if m.Health != nil {
	...
	if m.IsVisibleDire != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsVisibleDire)
		i--
		dAtA[i] = 0x60
	}
	if m.IsVisibleRadiant != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsVisibleRadiant)
		i--
		dAtA[i] = 0x58
	}
	if m.IsTargetHero != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsTargetHero)
		i--
		dAtA[i] = 0x50
	}
	if m.IsTargetIllusion != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsTargetIllusion)
		i--
		dAtA[i] = 0x48
	}
	if m.IsAttackerHero != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsAttackerHero)
		i--
		dAtA[i] = 0x40
	}
	if m.IsAttackerIllusion != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.IsAttackerIllusion)
		i--
		dAtA[i] = 0x38
	}
...
func (m *CMsgMonsterHunterInvestigation) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.SuccessState != nil {
		i = protobuf_go_lite.EncodeBool(dAtA, i, *m.SuccessState)
		i--
		dAtA[i] = 0x28
	}
...
func (m *CDOTAClientHardwareSpecs) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintPtr(1, m.LogicalProcessors)
	n += protobuf_go_lite.SizeFixed64Ptr(1, m.CpuCyclesPerSecond)
	n += protobuf_go_lite.SizeFixed64Ptr(1, m.TotalPhysicalMemory)
	n += protobuf_go_lite.SizeBoolPtr(1, m.Is_64BitOs)
	n += protobuf_go_lite.SizeVarintPtr(1, m.UploadMeasurement)
	n += protobuf_go_lite.SizeBoolPtr(1, m.PreferNotHost)
	n += protobuf_go_lite.SizeVarintSlice(1, m.Crc)
...
func (m *CDOTASaveGame_Player) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeStringPtr(1, m.Hero)
	n += len(m.unknownFields)
	return n
}
...
func (m *CDOTASaveGame_SaveInstance) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintPtr(1, m.Team1Score)
	n += protobuf_go_lite.SizeVarintPtr(1, m.Team2Score)
	for _, e := range m.PlayerPositions {
		l = e.SizeVT()
		n += protobuf_go_lite.SizeMessage(1, l)
	}
	n += protobuf_go_lite.SizeVarintPtr(1, m.SaveId)
	n += protobuf_go_lite.SizeVarintPtr(1, m.SaveTime)
	n += len(m.unknownFields)
	return n
}
...
func (m *CMsgDOTACombatLogEntry) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintPtr(1, m.TargetName)
	n += protobuf_go_lite.SizeVarintPtr(1, m.TargetSourceName)
	n += protobuf_go_lite.SizeVarintPtr(1, m.AttackerName)
	n += protobuf_go_lite.SizeVarintPtr(1, m.DamageSourceName)
	n += protobuf_go_lite.SizeVarintPtr(1, m.InflictorName)
	n += protobuf_go_lite.SizeBoolPtr(1, m.IsAttackerIllusion)
	n += protobuf_go_lite.SizeBoolPtr(1, m.IsAttackerHero)
	n += protobuf_go_lite.SizeBoolPtr(1, m.IsTargetIllusion)
	n += protobuf_go_lite.SizeBoolPtr(1, m.IsTargetHero)
	n += protobuf_go_lite.SizeBoolPtr(1, m.IsVisibleRadiant)
	n += protobuf_go_lite.SizeBoolPtr(1, m.IsVisibleDire)
	...
	n += protobuf_go_lite.SizeFixed32Ptr(2, m.SlowDuration)
	n += protobuf_go_lite.SizeBoolPtr(2, m.IsAbilityToggleOn)
	n += protobuf_go_lite.SizeBoolPtr(2, m.IsAbilityToggleOff)
	n += protobuf_go_lite.SizeVarintPtr(2, m.AbilityLevel)
	n += protobuf_go_lite.SizeFixed32Ptr(2, m.LocationX)
	n += protobuf_go_lite.SizeFixed32Ptr(2, m.LocationY)
	n += protobuf_go_lite.SizeVarintPtr(2, m.GoldReason)
	n += protobuf_go_lite.SizeFixed32Ptr(2, m.TimestampRaw)
	n += protobuf_go_lite.SizeFixed32Ptr(2, m.ModifierDuration)
	n += protobuf_go_lite.SizeVarintPtr(2, m.XpReason)
	n += protobuf_go_lite.SizeVarintPtr(2, m.LastHits)
	n += protobuf_go_lite.SizeVarintPtr(2, m.AttackerTeam)
	n += protobuf_go_lite.SizeVarintPtr(2, m.TargetTeam)
	n += protobuf_go_lite.SizeVarintPtr(2, m.ObsWardsPlaced)
	n += protobuf_go_lite.SizeVarintPtr(2, m.AssistPlayer0)
	n += protobuf_go_lite.SizeVarintPtr(2, m.AssistPlayer1)
	n += protobuf_go_lite.SizeVarintPtr(2, m.AssistPlayer2)
	n += protobuf_go_lite.SizeVarintPtr(2, m.AssistPlayer3)
	n += protobuf_go_lite.SizeVarintPtr(2, m.StackCount)
	n += protobuf_go_lite.SizeBoolPtr(2, m.HiddenModifier)
	n += protobuf_go_lite.SizeBoolPtr(2, m.IsTargetBuilding)
	n += protobuf_go_lite.SizeVarintPtr(2, m.NeutralCampType)
	n += protobuf_go_lite.SizeVarintPtr(2, m.RuneType)
	n += protobuf_go_lite.SizeVarintSlice(2, m.AssistPlayers)
	n += protobuf_go_lite.SizeBoolPtr(2, m.IsHealSave)
	n += protobuf_go_lite.SizeBoolPtr(2, m.IsUltimateAbility)
	n += protobuf_go_lite.SizeVarintPtr(2, m.AttackerHeroLevel)
	n += protobuf_go_lite.SizeVarintPtr(2, m.TargetHeroLevel)
	n += protobuf_go_lite.SizeVarintPtr(2, m.Xpm)
	n += protobuf_go_lite.SizeVarintPtr(2, m.Gpm)
	n += protobuf_go_lite.SizeVarintPtr(2, m.EventLocation)
	n += protobuf_go_lite.SizeBoolPtr(2, m.TargetIsSelf)
	n += protobuf_go_lite.SizeVarintPtr(2, m.DamageType)
	n += protobuf_go_lite.SizeBoolPtr(2, m.InvisibilityModifier)
	n += protobuf_go_lite.SizeVarintPtr(2, m.DamageCategory)
	n += protobuf_go_lite.SizeVarintPtr(2, m.Networth)
	n += protobuf_go_lite.SizeVarintPtr(2, m.BuildingType)
	n += protobuf_go_lite.SizeFixed32Ptr(2, m.ModifierElapsedDuration)
	n += protobuf_go_lite.SizeBoolPtr(2, m.SilenceModifier)
	n += protobuf_go_lite.SizeBoolPtr(2, m.HealFromLifesteal)
	n += protobuf_go_lite.SizeBoolPtr(2, m.ModifierPurged)
	n += protobuf_go_lite.SizeBoolPtr(2, m.SpellEvaded)
	n += protobuf_go_lite.SizeBoolPtr(2, m.MotionControllerModifier)
	n += protobuf_go_lite.SizeBoolPtr(2, m.LongRangeKill)
	n += protobuf_go_lite.SizeVarintPtr(2, m.ModifierPurgeAbility)
	n += protobuf_go_lite.SizeVarintPtr(2, m.ModifierPurgeNpc)
	n += protobuf_go_lite.SizeBoolPtr(2, m.RootModifier)
	n += protobuf_go_lite.SizeVarintPtr(2, m.TotalUnitDeathCount)
	n += protobuf_go_lite.SizeBoolPtr(2, m.AuraModifier)
	n += protobuf_go_lite.SizeBoolPtr(2, m.ArmorDebuffModifier)
	n += protobuf_go_lite.SizeBoolPtr(2, m.NoPhysicalDamageModifier)
	n += protobuf_go_lite.SizeVarintPtr(2, m.ModifierAbility)
	n += protobuf_go_lite.SizeBoolPtr(2, m.ModifierHidden)
	n += protobuf_go_lite.SizeBoolPtr(2, m.InflictorIsStolenAbility)
	n += protobuf_go_lite.SizeVarintPtr(2, m.KillEaterEvent)
	n += protobuf_go_lite.SizeVarintPtr(2, m.UnitStatusLabel)
	n += protobuf_go_lite.SizeBoolPtr(2, m.SpellGeneratedAttack)
	n += protobuf_go_lite.SizeBoolPtr(2, m.AtNightTime)
	n += protobuf_go_lite.SizeBoolPtr(2, m.AttackerHasScepter)
	n += protobuf_go_lite.SizeVarintPtr(2, m.NeutralCampTeam)
	n += protobuf_go_lite.SizeFixed32Ptr(2, m.RegeneratedHealth)
	n += protobuf_go_lite.SizeBoolPtr(2, m.WillReincarnate)
	n += protobuf_go_lite.SizeBoolPtr(2, m.UsesCharges)
	n += protobuf_go_lite.SizeVarintPtr(2, m.TrackedStatId)
	n += protobuf_go_lite.SizeFixed32Ptr(2, m.ModifierPurgedDuration)
	n += protobuf_go_lite.SizeBoolPtr(2, m.HealFromRegen)
	n += len(m.unknownFields)
	return n
}
...
func (m *CMsgPendingEventAward) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintPtr(1, m.NumToGrant)
	n += protobuf_go_lite.SizeVarintPtr(1, m.ScoreMode)
...
func (m *CMsgMonsterHunterInvestigation) SizeVT() (n int) {
	...
	n += protobuf_go_lite.SizeVarintPtr(1, m.PersonaId)
	if m.MatchRewards != nil {
	...
	n += protobuf_go_lite.SizeBoolPtr(1, m.SuccessState)
	n += len(m.unknownFields)
	return n
}
...
func (m *CMsgMonsterHunterCodexUpdateData_KillInfo) SizeVT() (n int) {
	...
	_ = l
	n += protobuf_go_lite.SizeVarintPtr(1, m.HeroId)
	n += protobuf_go_lite.SizeVarintPtr(1, m.KillCount)
	n += len(m.unknownFields)
	return n
}
...
func (m *CMsgMonsterHunterCodexUpdateData) SizeVT() (n int) {
	...
	var l int
	_ = l
	n += protobuf_go_lite.SizeVarintPtr(1, m.PlayerHero)
	n += protobuf_go_lite.SizeVarintSlice(1, m.Allies)
	n += protobuf_go_lite.SizeVarintSlice(1, m.Enemies)
...
func (x *CDOTAClientHardwareSpecs) MarshalProtoText() string {
	...
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CDOTAClientHardwareSpecs")
	if x.LogicalProcessors != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "logical_processors")
		protobuf_go_lite.TextWriteUint(&sb, *x.LogicalProcessors)
	}
	if x.CpuCyclesPerSecond != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "cpu_cycles_per_second")
		protobuf_go_lite.TextWriteUint(&sb, *x.CpuCyclesPerSecond)
	}
	if x.TotalPhysicalMemory != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "total_physical_memory")
		protobuf_go_lite.TextWriteUint(&sb, *x.TotalPhysicalMemory)
	}
	if x.Is_64BitOs != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_64_bit_os")
		protobuf_go_lite.TextWriteBool(&sb, *x.Is_64BitOs)
	}
	if x.UploadMeasurement != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "upload_measurement")
		protobuf_go_lite.TextWriteUint(&sb, *x.UploadMeasurement)
	}
	if x.PreferNotHost != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "prefer_not_host")
		protobuf_go_lite.TextWriteBool(&sb, *x.PreferNotHost)
	}
	if len(x.Crc) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "crc")
		for i, v := range x.Crc {
...
func (x *CDOTASaveGame_Player) MarshalProtoText() string {
	...
	if x.Hero != nil {
		...
		protobuf_go_lite.TextWriteString(&sb, *x.Hero)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *CDOTASaveGame_SaveInstance_PlayerPositions) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "PlayerPositions")
	if x.X != nil {
...
func (x *CDOTASaveGame_SaveInstance) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "SaveInstance")
	if x.GameTime != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "game_time")
		protobuf_go_lite.TextWriteUint(&sb, *x.GameTime)
	}
	if x.Team1Score != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "team1_score")
		protobuf_go_lite.TextWriteUint(&sb, *x.Team1Score)
	}
	if x.Team2Score != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "team2_score")
		protobuf_go_lite.TextWriteUint(&sb, *x.Team2Score)
	}
	if len(x.PlayerPositions) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "player_positions")
		for i, v := range x.PlayerPositions {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &CDOTASaveGame_SaveInstance_PlayerPositions{})
			} else {
	...
	if x.SaveId != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "save_id")
		protobuf_go_lite.TextWriteUint(&sb, *x.SaveId)
	}
	if x.SaveTime != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "save_time")
		protobuf_go_lite.TextWriteUint(&sb, *x.SaveTime)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *CDOTASaveGame) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CDOTASaveGame")
	if x.SaveTime != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "save_time")
		protobuf_go_lite.TextWriteUint(&sb, *x.SaveTime)
	}
	if len(x.Players) > 0 {
		...
		for i, v := range x.Players {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &CDOTASaveGame_Player{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
	...
	if len(x.SaveInstances) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "save_instances")
		for i, v := range x.SaveInstances {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &CDOTASaveGame_SaveInstance{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
...
func (x *CMsgDOTACombatLogEntry) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CMsgDOTACombatLogEntry")
	if x.Type != nil {
	...
	if x.TargetName != nil {
		...
		protobuf_go_lite.TextWriteUint(&sb, *x.TargetName)
	}
	if x.TargetSourceName != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "target_source_name")
		protobuf_go_lite.TextWriteUint(&sb, *x.TargetSourceName)
	}
	if x.AttackerName != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "attacker_name")
		protobuf_go_lite.TextWriteUint(&sb, *x.AttackerName)
	}
	if x.DamageSourceName != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "damage_source_name")
		protobuf_go_lite.TextWriteUint(&sb, *x.DamageSourceName)
	}
	if x.InflictorName != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "inflictor_name")
		protobuf_go_lite.TextWriteUint(&sb, *x.InflictorName)
	}
	if x.IsAttackerIllusion != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_attacker_illusion")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsAttackerIllusion)
	}
	if x.IsAttackerHero != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_attacker_hero")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsAttackerHero)
	}
	if x.IsTargetIllusion != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_target_illusion")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsTargetIllusion)
	}
	if x.IsTargetHero != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_target_hero")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsTargetHero)
	}
	if x.IsVisibleRadiant != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_visible_radiant")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsVisibleRadiant)
	}
	if x.IsVisibleDire != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_visible_dire")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsVisibleDire)
	}
	if x.Value != nil {
	...
	if x.Timestamp != nil {
		...
		protobuf_go_lite.TextWriteFloat32(&sb, *x.Timestamp)
	}
	...
	if x.SlowDuration != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "slow_duration")
		protobuf_go_lite.TextWriteFloat32(&sb, *x.SlowDuration)
	}
	if x.IsAbilityToggleOn != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_ability_toggle_on")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsAbilityToggleOn)
	}
	if x.IsAbilityToggleOff != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_ability_toggle_off")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsAbilityToggleOff)
	}
	if x.AbilityLevel != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "ability_level")
		protobuf_go_lite.TextWriteUint(&sb, *x.AbilityLevel)
	}
	if x.LocationX != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "location_x")
		protobuf_go_lite.TextWriteFloat32(&sb, *x.LocationX)
	}
	if x.LocationY != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "location_y")
		protobuf_go_lite.TextWriteFloat32(&sb, *x.LocationY)
	}
	if x.GoldReason != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "gold_reason")
		protobuf_go_lite.TextWriteUint(&sb, *x.GoldReason)
	}
	if x.TimestampRaw != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "timestamp_raw")
		protobuf_go_lite.TextWriteFloat32(&sb, *x.TimestampRaw)
	}
	if x.ModifierDuration != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "modifier_duration")
		protobuf_go_lite.TextWriteFloat32(&sb, *x.ModifierDuration)
	}
	if x.XpReason != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "xp_reason")
		protobuf_go_lite.TextWriteUint(&sb, *x.XpReason)
	}
	if x.LastHits != nil {
	...
	if x.AttackerTeam != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "attacker_team")
		protobuf_go_lite.TextWriteUint(&sb, *x.AttackerTeam)
	}
	if x.TargetTeam != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "target_team")
		protobuf_go_lite.TextWriteUint(&sb, *x.TargetTeam)
	}
	if x.ObsWardsPlaced != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "obs_wards_placed")
		protobuf_go_lite.TextWriteUint(&sb, *x.ObsWardsPlaced)
	}
	if x.AssistPlayer0 != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "assist_player0")
		protobuf_go_lite.TextWriteUint(&sb, *x.AssistPlayer0)
	}
	if x.AssistPlayer1 != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "assist_player1")
		protobuf_go_lite.TextWriteUint(&sb, *x.AssistPlayer1)
	}
	if x.AssistPlayer2 != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "assist_player2")
		protobuf_go_lite.TextWriteUint(&sb, *x.AssistPlayer2)
	}
	if x.AssistPlayer3 != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "assist_player3")
		protobuf_go_lite.TextWriteUint(&sb, *x.AssistPlayer3)
	}
	if x.StackCount != nil {
	...
	if x.HiddenModifier != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "hidden_modifier")
		protobuf_go_lite.TextWriteBool(&sb, *x.HiddenModifier)
	}
	if x.IsTargetBuilding != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_target_building")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsTargetBuilding)
	}
	if x.NeutralCampType != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "neutral_camp_type")
		protobuf_go_lite.TextWriteUint(&sb, *x.NeutralCampType)
	}
	if x.RuneType != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "rune_type")
		protobuf_go_lite.TextWriteUint(&sb, *x.RuneType)
	}
	if len(x.AssistPlayers) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "assist_players")
	...
	if x.IsHealSave != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_heal_save")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsHealSave)
	}
	if x.IsUltimateAbility != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "is_ultimate_ability")
		protobuf_go_lite.TextWriteBool(&sb, *x.IsUltimateAbility)
	}
	if x.AttackerHeroLevel != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "attacker_hero_level")
		protobuf_go_lite.TextWriteUint(&sb, *x.AttackerHeroLevel)
	}
	if x.TargetHeroLevel != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "target_hero_level")
		protobuf_go_lite.TextWriteUint(&sb, *x.TargetHeroLevel)
	}
	if x.Xpm != nil {
	...
	if x.EventLocation != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "event_location")
		protobuf_go_lite.TextWriteUint(&sb, *x.EventLocation)
	}
	if x.TargetIsSelf != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "target_is_self")
		protobuf_go_lite.TextWriteBool(&sb, *x.TargetIsSelf)
	}
	if x.DamageType != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "damage_type")
		protobuf_go_lite.TextWriteUint(&sb, *x.DamageType)
	}
	if x.InvisibilityModifier != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "invisibility_modifier")
		protobuf_go_lite.TextWriteBool(&sb, *x.InvisibilityModifier)
	}
	if x.DamageCategory != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "damage_category")
		protobuf_go_lite.TextWriteUint(&sb, *x.DamageCategory)
	}
	if x.Networth != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "networth")
		protobuf_go_lite.TextWriteUint(&sb, *x.Networth)
	}
	if x.BuildingType != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "building_type")
		protobuf_go_lite.TextWriteUint(&sb, *x.BuildingType)
	}
	if x.ModifierElapsedDuration != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "modifier_elapsed_duration")
		protobuf_go_lite.TextWriteFloat32(&sb, *x.ModifierElapsedDuration)
	}
	if x.SilenceModifier != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "silence_modifier")
		protobuf_go_lite.TextWriteBool(&sb, *x.SilenceModifier)
	}
	if x.HealFromLifesteal != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "heal_from_lifesteal")
		protobuf_go_lite.TextWriteBool(&sb, *x.HealFromLifesteal)
	}
	if x.ModifierPurged != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "modifier_purged")
		protobuf_go_lite.TextWriteBool(&sb, *x.ModifierPurged)
	}
	if x.SpellEvaded != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "spell_evaded")
		protobuf_go_lite.TextWriteBool(&sb, *x.SpellEvaded)
	}
	if x.MotionControllerModifier != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "motion_controller_modifier")
		protobuf_go_lite.TextWriteBool(&sb, *x.MotionControllerModifier)
	}
	if x.LongRangeKill != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "long_range_kill")
		protobuf_go_lite.TextWriteBool(&sb, *x.LongRangeKill)
	}
	if x.ModifierPurgeAbility != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "modifier_purge_ability")
		protobuf_go_lite.TextWriteUint(&sb, *x.ModifierPurgeAbility)
	}
	if x.ModifierPurgeNpc != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "modifier_purge_npc")
		protobuf_go_lite.TextWriteUint(&sb, *x.ModifierPurgeNpc)
	}
	if x.RootModifier != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "root_modifier")
		protobuf_go_lite.TextWriteBool(&sb, *x.RootModifier)
	}
	if x.TotalUnitDeathCount != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "total_unit_death_count")
		protobuf_go_lite.TextWriteUint(&sb, *x.TotalUnitDeathCount)
	}
	if x.AuraModifier != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "aura_modifier")
		protobuf_go_lite.TextWriteBool(&sb, *x.AuraModifier)
	}
	if x.ArmorDebuffModifier != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "armor_debuff_modifier")
		protobuf_go_lite.TextWriteBool(&sb, *x.ArmorDebuffModifier)
	}
	if x.NoPhysicalDamageModifier != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "no_physical_damage_modifier")
		protobuf_go_lite.TextWriteBool(&sb, *x.NoPhysicalDamageModifier)
	}
	if x.ModifierAbility != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "modifier_ability")
		protobuf_go_lite.TextWriteUint(&sb, *x.ModifierAbility)
	}
	if x.ModifierHidden != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "modifier_hidden")
		protobuf_go_lite.TextWriteBool(&sb, *x.ModifierHidden)
	}
	if x.InflictorIsStolenAbility != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "inflictor_is_stolen_ability")
		protobuf_go_lite.TextWriteBool(&sb, *x.InflictorIsStolenAbility)
	}
	if x.KillEaterEvent != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "kill_eater_event")
		protobuf_go_lite.TextWriteUint(&sb, *x.KillEaterEvent)
	}
	if x.UnitStatusLabel != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "unit_status_label")
		protobuf_go_lite.TextWriteUint(&sb, *x.UnitStatusLabel)
	}
	if x.SpellGeneratedAttack != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "spell_generated_attack")
		protobuf_go_lite.TextWriteBool(&sb, *x.SpellGeneratedAttack)
	}
	if x.AtNightTime != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "at_night_time")
		protobuf_go_lite.TextWriteBool(&sb, *x.AtNightTime)
	}
	if x.AttackerHasScepter != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "attacker_has_scepter")
		protobuf_go_lite.TextWriteBool(&sb, *x.AttackerHasScepter)
	}
	if x.NeutralCampTeam != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "neutral_camp_team")
		protobuf_go_lite.TextWriteUint(&sb, *x.NeutralCampTeam)
	}
	if x.RegeneratedHealth != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "regenerated_health")
		protobuf_go_lite.TextWriteFloat32(&sb, *x.RegeneratedHealth)
	}
	if x.WillReincarnate != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "will_reincarnate")
		protobuf_go_lite.TextWriteBool(&sb, *x.WillReincarnate)
	}
	if x.UsesCharges != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "uses_charges")
		protobuf_go_lite.TextWriteBool(&sb, *x.UsesCharges)
	}
	if x.TrackedStatId != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "tracked_stat_id")
		protobuf_go_lite.TextWriteUint(&sb, *x.TrackedStatId)
	}
	if x.ModifierPurgedDuration != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "modifier_purged_duration")
		protobuf_go_lite.TextWriteFloat32(&sb, *x.ModifierPurgedDuration)
	}
	if x.HealFromRegen != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "heal_from_regen")
		protobuf_go_lite.TextWriteBool(&sb, *x.HealFromRegen)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *CMsgPendingEventAward) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CMsgPendingEventAward")
	if x.EventId != nil {
	...
	if x.NumToGrant != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "num_to_grant")
		protobuf_go_lite.TextWriteUint(&sb, *x.NumToGrant)
	}
	if x.ScoreMode != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "score_mode")
		protobuf_go_lite.TextWriteStringer(&sb, x.ScoreMode)
	}
...
func (x *CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "MaterialCountsEntry")
	if x.Key != nil {
...
func (x *CMsgMonsterHunterMaterialQuantity) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CMsgMonsterHunterMaterialQuantity")
	if len(x.MaterialCounts) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "material_counts")
		for i, v := range x.MaterialCounts {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &CMsgMonsterHunterMaterialQuantity_MaterialCountsEntry{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
...
func (x *CMsgMonsterHunterInvestigation) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CMsgMonsterHunterInvestigation")
	if x.HeroId != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "hero_id")
		protobuf_go_lite.TextWriteInt(&sb, *x.HeroId)
	}
	if x.PersonaId != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "persona_id")
		protobuf_go_lite.TextWriteInt(&sb, *x.PersonaId)
	}
	if x.MatchRewards != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "match_rewards")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.MatchRewards)
	}
	if x.HuntRewards != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "hunt_rewards")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.HuntRewards)
	}
	if x.SuccessState != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "success_state")
		protobuf_go_lite.TextWriteBool(&sb, *x.SuccessState)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *CMsgMonsterHunterInvestigationGameState_HuntedBy) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "HuntedBy")
	if x.HeroId != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "hero_id")
		protobuf_go_lite.TextWriteInt(&sb, *x.HeroId)
	}
...
func (x *CMsgMonsterHunterInvestigationGameState) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CMsgMonsterHunterInvestigationGameState")
	if x.SelectedInvestigation != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "selected_investigation")
		protobuf_go_lite.TextWriteTextMarshaler(&sb, x.SelectedInvestigation)
	}
	if len(x.HuntedBy) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "hunted_by")
		for i, v := range x.HuntedBy {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &CMsgMonsterHunterInvestigationGameState_HuntedBy{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
...
func (x *CMsgMonsterHunterCodexUpdateData_KillInfo) MarshalProtoText() string {
	...
	if x.KillCount != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "kill_count")
		protobuf_go_lite.TextWriteInt(&sb, *x.KillCount)
	}
	return protobuf_go_lite.TextFinishMessage(&sb)
}
...
func (x *CMsgMonsterHunterCodexUpdateData) MarshalProtoText() string {
	var sb protobuf_go_lite.TextBuilder
	initialLen := protobuf_go_lite.TextStartMessage(&sb, "CMsgMonsterHunterCodexUpdateData")
	if x.PlayerHero != nil {
		protobuf_go_lite.TextWriteFieldPrefix(&sb, initialLen, "player_hero")
		protobuf_go_lite.TextWriteInt(&sb, *x.PlayerHero)
	}
	if len(x.Allies) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "allies")
	...
	if len(x.Enemies) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "enemies")
	...
	if len(x.PlayerKills) > 0 {
		protobuf_go_lite.TextWriteListStart(&sb, initialLen, "player_kills")
		for i, v := range x.PlayerKills {
			protobuf_go_lite.TextWriteListSeparator(&sb, i)
			if v == nil {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, &CMsgMonsterHunterCodexUpdateData_KillInfo{})
			} else {
				protobuf_go_lite.TextWriteTextMarshaler(&sb, v)
			}
		}
...
func (m *CDOTASaveGame_SaveInstance) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if err := m.PlayerPositions[len(m.PlayerPositions)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *CDOTASaveGame) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.SaveInstances[len(m.SaveInstances)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
func (m *CMsgMonsterHunterMaterialQuantity) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.MaterialCounts[len(m.MaterialCounts)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CMsgMonsterHunterInvestigation) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.MatchRewards.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			...
			if err := m.HuntRewards.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
func (m *CMsgMonsterHunterInvestigationGameState) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.SelectedInvestigation.UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if err := m.HuntedBy[len(m.HuntedBy)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CMsgMonsterHunterCodexUpdateData) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.PlayerKills[len(m.PlayerKills)-1].UnmarshalVT(dAtA[msgStart:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
