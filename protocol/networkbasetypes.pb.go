...
const file_networkbasetypes_proto_rawDesc = "" +
	"\n" +
	"\x16networkbasetypes.proto\x12\bprotocol\x1a\x15valveextensions.proto\x1a google/protobuf/descriptor.proto\x1a\x18network_connection.proto\"J\n" +
	"\n" +
	"CMsgVector\x12\f\n" +
	...
	"\x01y\x18\x02 \x01(\x02R\x01y\x12\f\n" +
	"\x01z\x18\x03 \x01(\x02R\x01z\x12\f\n" +
	"\x01w\x18\x04 \x01(\x02R\x01w:\x04\xc0\xe4\x1d\x01\"\x99\x01\n" +
	"\rCMsgTransform\x120\n" +
	"\bposition\x18\x01 \x01(\v2\x14.protocol.CMsgVectorR\bposition\x12\x14\n" +
	"\x05scale\x18\x02 \x01(\x02R\x05scale\x12:\n" +
	"\vorientation\x18\x03 \x01(\v2\x18.protocol.CMsgQuaternionR\vorientation:\x04\xc0\xe4\x1d\x01\"H\n" +
	"\bCMsgRGBA\x12\f\n" +
